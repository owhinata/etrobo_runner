...
cv::Rect CameraCalibrator::Impl::valid_roi(const cv::Mat& img,
...
cv::Mat CameraCalibrator::Impl::create_hsv_mask(const cv::Mat& bgr_img) {
  cv::Mat hsv;
...
double CameraCalibrator::Impl::score_ellipse(const cv::RotatedRect& ellipse,
